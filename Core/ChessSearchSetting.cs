    ...
    public class ChessSearchSetting : SearchEngineSetting
    {
        ...
        private static Book? ReadBook(string bookName)
        {
            ...
            if (!succeed)
            {
                try
                {
                    if (!retVal.ReadBookFromResource("ChessMaster." + bookName + ".bin"))
                    {
                        retVal = null;
                    }
                }
        ...
        /// </summary>
        public static Book? Book2500 { get; private set; }
        ...
        public override string HumanSearchMode()
        {
            ...
            return HumanSearchMode(bookMode);
        }
