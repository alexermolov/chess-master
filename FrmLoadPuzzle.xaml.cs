...
namespace ChessMaster
{
    ...
    public partial class FrmLoadPuzzle : Window {
        ...
        private string LoadPgn() {
            ...
            stream  = assem.GetManifestResourceStream("ChessMaster.111probs.pgn");
            reader  = new System.IO.StreamReader(stream ?? throw new InvalidOperationException("Unable to find the ChessMaster.111probs.pgn resource"),
                                                 Encoding.ASCII);
            try {
