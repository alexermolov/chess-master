...
namespace ChessMaster
{
    ...
    internal class SettingAdaptor
    {
        ...
        public void LoadSearchMode(BoardEvaluationUtil boardEvalUtil, out ChessSearchSetting chessSearchSetting)
        {
            ...
            difficultyLevel = Settings.DifficultyLevel is >= 0 and < 6 ? (ChessSearchSetting.SettingDifficultyLevel)Settings.DifficultyLevel : ChessSearchSetting.SettingDifficultyLevel.Manual;
            ...
            searchDepth = Settings.UsePlyCount | Settings.UsePlyCountIterative ? Settings.PlyCount is > 1 and < 12 ? Settings.PlyCount : 6 : 0;
            timeOutInSec = Settings.UsePlyCount | Settings.UsePlyCountIterative ? 0 : Settings.AverageTime is > 0 and < 1000 ? Settings.AverageTime : 15;
            randomMode = Settings.RandomMode is >= 0 and <= 2 ? (RandomMode)Settings.RandomMode : RandomMode.On;
            searchEngineSetting = new SearchEngineSetting(searchOption, threadingMode, searchDepth, timeOutInSec, randomMode, transTableEntryCount);
        ...
        public void SaveSearchMode(ChessSearchSetting chessSearchSetting)
        {
            ...
            Settings.DifficultyLevel = (int)chessSearchSetting.DifficultyLevel;
