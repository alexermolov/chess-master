...
namespace ChessMaster.PgnParsing
{
    ...
    public class PgnGame
    {
        ...
        public string SanMovesTxt { get => string.Join("", SanMoves); }
        ...
        public PgnGame()
        {
            Attrs = new Dictionary<string, string>(10, StringComparer.InvariantCultureIgnoreCase);
            SanMoves = new List<string>(256);
